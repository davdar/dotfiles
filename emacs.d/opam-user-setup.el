...
;; ## added by OPAM user-setup for emacs / tuareg ## c32b17da25a3e5b6647629d31729101a ## you can edit, but keep this line
...
(when (not (member "tuareg" opam-tools-installed))
  (defun opam-tuareg-autoload (fct file doc args)
    (let ((load-path (cons "/Users/daviddarais/.opam/system/share/emacs/site-lisp" load-path)))
      (load file))
    (apply fct args))
